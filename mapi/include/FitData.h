...
public: 
    struct Parameter
    {
        ...
        static constexpr columnIdx BaseAddress = 1;
        static constexpr columnIdx StartBit = 2;
        static constexpr columnIdx EndBit = 3;
        static constexpr columnIdx RegBlockSize = 4;
        static constexpr columnIdx MinValue = 5;
        static constexpr columnIdx MaxValue = 6;
        static constexpr columnIdx IsSigned = 7;
        static constexpr columnIdx IsFifo = 8;
        static constexpr columnIdx IsReadOnly = 9;
        static constexpr columnIdx EqElectronicToPhysic = 10;
        static constexpr columnIdx EqPhysicToElectronic = 11;
        static constexpr columnIdx RefreshType = 12;
