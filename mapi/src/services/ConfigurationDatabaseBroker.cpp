...
Result<std::string, std::string> ConfigurationDatabaseBroker::constructInsertParameters(std::string_view line)
{
    ...
    query.insert(db_tables::ConfigurationParameters::ConfigurationName.name, insert.configName)(db_tables::ConfigurationParameters::BoardName.name, insert.boardName)(db_tables::ConfigurationParameters::BoardType.name, boardType)(db_tables::ConfigurationParameters::ParameterName.name, insert.paramName)(db_tables::ConfigurationParameters::ParameterValue.name, std::to_string(electronicValue)).into(db_tables::ConfigurationParameters::TableName);
...
Result<std::string, std::string> ConfigurationDatabaseBroker::constructInsertConfiguration(std::string_view line)
{
    ...
    sql::InsertModel query;
    query.insert(db_tables::Configurations::ConfigurationName.name, insert.configName)(db_tables::Configurations::Author.name, insert.author)(db_tables::Configurations::Comment.name, insert.comment).into(db_tables::Configurations::TableName);
    return { .ok = query.str(), .error = std::nullopt };
}
...
Result<std::string, std::string> ConfigurationDatabaseBroker::constructUpdateParameters(std::string_view line)
{
    ...
    query.update(db_tables::ConfigurationParameters::TableName).set(db_tables::ConfigurationParameters::ParameterValue.name, std::to_string(electronicValue)).where(sql::column(db_tables::ConfigurationParameters::ConfigurationName.name) == update.configName && sql::column(db_tables::ConfigurationParameters::BoardType.name) == boardType && sql::column(db_tables::ConfigurationParameters::BoardName.name) == update.boardName && sql::column(db_tables::ConfigurationParameters::ParameterName.name) == update.paramName);
    return { .ok = query.str(), .error = std::nullopt };
}
